...
(*   Updated: 2025/05/13 18:37:46 by ydumaine         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
class dalek =
  object (self)
    ...
    method take_damage dmg =
      print_endline
        (_name ^ " take "
        ^ string_of_int (if _shield then dmg / 2 else dmg)
        ^ " dmg.");
