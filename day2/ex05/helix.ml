...
(*   Updated: 2025/02/20 16:41:07 by ydumaine         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let () = 
  ...
  print_string (helix_to_string (generate_helix (-1))); print_newline ();
  ...
  print_string (helix_to_string (generate_helix 0)); print_newline ();

  print_newline ();
  print_string "===== Test to generate a helix with a length of 10 =====\n";
  print_string (helix_to_string (generate_helix 10)); print_newline ();

  print_newline ();
  print_string "===== Test to generate a complementary helix with an empty helix =====\n";
  print_string (helix_to_string (complementary_helix [])); print_newline ();

  print_newline ();
  print_string "===== Test to generate a complementary helix with a helix of size 10 =====\n";
  let helix = generate_helix 10 in 
  print_string (helix_to_string helix); print_newline ();
  print_string (helix_to_string (complementary_helix (helix))); print_newline ();

  print_newline ();
  print_string "===== Test to generate a complementary helix with a helix of size 50 =====\n";
