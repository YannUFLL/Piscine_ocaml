...
(*   Updated: 2025/02/20 16:41:13 by ydumaine         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let () = 
  ...
  print_string (rna_to_string (generate_rna [])) ; print_newline ();

  print_newline ();
  print_string "===== Test to generate an helix with an length of 7 =====\n";
  let helix1 = generate_helix 7 in begin
  print_string (helix_to_string (helix1)) ; print_newline ();

  print_newline ();
  print_string "===== Test to convert an helix with an length of 7 to rna =====\n";
  print_string (rna_to_string (generate_rna helix1));print_newline (); end;

  print_newline ();
  print_string "===== Test to generate an helix with an length of 50 =====\n";
  let helix2 = generate_helix 50 in begin
  print_string (helix_to_string (helix2)) ; print_newline ();

  print_newline ();
  print_string "===== Test to convert an helix with an length of 50 to rna =====\n";
  print_string (rna_to_string (generate_rna helix2)); print_newline ();end;
