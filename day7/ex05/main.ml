...
let print_chem_list lst =
  let rec aux = function
    | [] -> ()
    | [ (mol, coef) ] -> Printf.printf "%d %s" coef mol#formula
    | (mol, coef) :: t ->
