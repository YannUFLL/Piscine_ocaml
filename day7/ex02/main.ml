...
(*   Updated: 2025/05/13 18:27:15 by ydumaine         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let () =
  ...
  if (new Alkane.methane)#compare (new Alkane.methane :> Molecule.molecule) then
    "true" |> print_endline
  else "false" |> print_endline;
  if (new Alkane.methane)#compare (new Alkane.ethane :> Molecule.molecule) then
    "true" |> print_endline
  else "false" |> print_endline
