...
(*   Updated: 2025/03/05 14:30:20 by ydumaine         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let () =
  ...
  print_string "Testing Deck.newDeck:"; print_newline ();
...
let rec empty_deck deck =
  ...
  | exception Failure _ -> deck  in

print_string "Emptying deck1..."; print_newline ();
let empty_deck1 = empty_deck deck1 in

print_string "Testing Deck.drawCard on empty deck:"; print_newline ();
