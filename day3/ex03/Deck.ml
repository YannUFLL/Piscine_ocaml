...
(*   Updated: 2025/05/13 18:41:16 by ydumaine         ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let newDeck () =
  let rec extract_at idx lst acc =
    ...
    | x :: xs ->
        ...
        else extract_at (idx - 1) xs (x :: acc)
  in
  ...
  let rec shuffle lst acc =
    ...
    | _ ->
        ...
        shuffle rest (picked :: acc)
  in

  let deck =
    Card.allSpades @ Card.allClubs @ Card.allDiamonds @ Card.allHearts
  in
  shuffle deck []
